    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <ul class="space-y-2 text-gray-700">
                ...
                <li><a href="about.php" class="block font-semibold text-wisteria-deep">About</a></li>
                <li>
            ...
            <form action="proses_edit_about.php" method="post" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="about" name="about" rows="5" required
                        class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-wisteria-deep"><?php echo htmlspecialchars($data['about']); ?></textarea>
                </div>
