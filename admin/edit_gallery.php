...
<body class="bg-wisteria-light min-h-screen">
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            <h2 class="text-xl font-semibold text-wisteria-deep mb-4 text-center">MENU</h2>
            <ul class="space-y-2 text-gray-700">
                <li><a href="beranda_admin.php" class="block hover:text-wisteria-deep">Beranda</a></li>
                <li><a href="data_artikel.php" class="block hover:text-wisteria-deep">Kelola Artikel</a></li>
                <li><a href="data_gallery.php" class="block font-semibold text-wisteria-deep">Kelola Gallery</a></li>
                <li><a href="about.php" class="block hover:text-wisteria-deep">About</a></li>
                <li>
            ...
            <form action="proses_edit_gallery.php" method="post" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="judul" name="judul" required
                        ...
                        class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-wisteria-deep">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="file" id="foto" name="foto" accept="image/*"
                        class="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-wisteria-light file:text-wisteria-deep hover:file:bg-wisteria">
                </div>
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-wisteria text-white px-4 py-2 rounded hover:bg-wisteria-deep transition">Simpan Perubahan</button>
