    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <ul class="space-y-2 text-gray-700">
                ...
                <li><a href="data_artikel.php" class="block font-semibold text-wisteria-deep">Kelola Artikel</a></li>
                <li><a href="data_gallery.php" class="block hover:text-wisteria-deep">Kelola Gallery</a></li>
            ...
            <form action="proses_edit_artikel.php" method="post" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="isi_artikel" name="isi_artikel" rows="5" required
                        class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-wisteria-deep"><?php echo htmlspecialchars($data['isi_artikel']); ?></textarea>
                </div>
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-wisteria text-white px-4 py-2 rounded hover:bg-wisteria-deep transition">Update</button>
