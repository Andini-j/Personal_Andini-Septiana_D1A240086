        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="add_about.php"
                    class="bg-wisteria-dark text-white px-4 py-2 rounded hover:bg-wisteria transition">+ Tambah Data</a>
            </div>
            <div class="space-y-4">
                <?php
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    echo "<a href='edit_about.php?id_about={$data['id_about']}' class='text-wisteria-dark hover:underline'>Edit</a>";
