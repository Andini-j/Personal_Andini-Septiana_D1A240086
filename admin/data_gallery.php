        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="add_gallery.php"
                    class="bg-wisteria text-white px-4 py-2 rounded hover:bg-wisteria-deep transition">+ Tambah Gambar</a>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    echo "<a href='edit_gallery.php?id_gallery={$data['id_gallery']}' class='text-wisteria-deep hover:underline'>Edit</a>";
