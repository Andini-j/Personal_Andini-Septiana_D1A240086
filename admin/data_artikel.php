...
<body class="bg-wisteria-light min-h-screen">
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="add_artikel.php"
                    class="bg-wisteria text-white px-4 py-2 rounded hover:bg-wisteria-dark transition">+ Tambah Artikel</a>
            </div>
            <table class="min-w-full table-auto border border-gray-300 text-sm">
                <thead class="bg-wisteria text-white">
                    <tr>
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        ...
                        echo "<td class='border p-2 text-center space-x-2'>
                            <a href='edit_artikel.php?id_artikel={$data['id_artikel']}' class='text-wisteria-deep hover:underline'>Edit</a>
    ...
    <!-- Footer -->
    <footer class="bg-wisteria-dark text-white text-center py-5 mt-20">
